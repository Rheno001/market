  ...
  return(<div className='px-[20px] bg-black'>
    ...
    <section className='p-[50px] px-[150px]'>
     <div className='hero flex flex-col items-center bg-cover bg-no-repeat bg-center py-[60px] lg:py-[100px] mt-[50px]' style={{ backgroundImage: `url(${gridlines})` }}>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center mt-[30px] lg:mt-[80px]'>
        <p className='lg:text-[15px] text-center  text-[white]'>Modern <span className='text-[#E26E23]'>Problem </span>Requires Modern <span className='text-[#E26E23]'>Solution</span></p>
