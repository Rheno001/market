...
function App() {
  return(<div className='px-[20px] bg-black'>
    ...
    <section className='p-[50px] px-[150px]'>
     <div className='hero flex flex-col items-center bg-cover bg-no-repeat bg-center py-[60px] lg:py-[100px] lg:mt-[50px]' style={{ backgroundImage: `url(${gridlines})` }}>
      ...
      <div className='flex items-center justify-center mt-[30px] lg:mt-[80px]'>
        <p className='text-[6px] lg:text-[15px] text-[white]'>Modern <span className='text-[#E26E23]'>Problem </span>Requires Modern <span className='text-[#E26E23]'>Solution</span></p>
        <button className='mx-[10px] text-[5px] lg:text-[12px] bg-[#E26E23] flex items-center justify-center text-white rounded-xl h-[15px] lg:h-[30px] p-[12px] lg:p-[18px]'>Lets Connect <img src={vector} alt="" className='h-[8px] lg:h-[20px] mx-[5px] lg:mx-[10px]' /></button>
      </div>
     </div>
